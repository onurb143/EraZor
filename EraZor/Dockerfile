...
# Kopier projektfilerne for EF-kommandosupport - kun til udvikling da det bruges til at holde databasen up-to-date , in real life vil man køre migrations igennem CI/CD pipeline
COPY EraZor.csproj .
